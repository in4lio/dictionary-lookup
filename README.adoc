...
There are URL templates with lists of possible language combinations for several online dictionaries in the following table. You can use them to configure this add-on. The highlighted portion of a URL template could be replaced with one of the options from the rightmost column.
