...
[NOTE]
*You have to allow pop-ups for* `docs.google.com` *in Google Chrome since a translation appears on a new tab.*
...
Click "Default" to return updated default preferences.
